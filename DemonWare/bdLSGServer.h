...
class bdStunServer1 : public bdServiceServer
{
public:
	bdStunServer1(){};
	...
	{
		return "mw3-stun.us.demonware.net";
	}
};

class bdStunServer2 : public bdServiceServer
{
public:
	bdStunServer2(){};
	...
	virtual const char* getHostName()
	{
		return "mw3-stun.eu.demonware.net";
	}
};
...
public:
	...
	virtual const char* getHostName()
	{
		return "mw3-pc-lobby.prod.demonware.net";
	}
};
...
private:
	...
	void updateSessionsFromNP(bdServiceServer* server, PMDictionary& dict);
