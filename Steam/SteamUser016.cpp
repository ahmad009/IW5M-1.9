...
{
	if (!PM_RequestTicket(pAuthBlob, cbMaxAuthBlob, steamIDGameServer.ConvertToUint64()))
	{
		return 0;
	}

	//TODO: validate data and let him/her connect

	return sizeof(PMAuthenticateTicket);
}
...
SteamAPICall_t CSteamUser016::RequestEncryptedAppTicket(void *pUserData, int cbUserData)
{
	...
	Log::Debug("SteamUser016", "RequestEncryptedAppTicket");
#if STEAM_PROXY
...
{
	Log::Debug("SteamUser016", "GetEncryptedAppTicket");
#if STEAM_PROXY
